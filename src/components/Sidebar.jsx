...
import profileImage from '../assets/images/my_profile-2.jpg';
import signature from '../assets/images/signature2.gif';
        ...
        <aside>
            ...
            <div className="about-me">
                ...
                <figure className="image avater">
                    ...
                    <img src={profileImage} alt="Toufik Shima Front-end Developer" />
                ...
                <figure className="image signature">
                    ...
                    <img src={signature} alt="Toufik Shima Signature" />
